<template>
    <div class="mobile-feedback" v-cloak :style="queryType==1000&&'margin-top: 0.88rem;border-top:2px solid #F5F6F7;'">
        ...
        <div class="module-box">
            ...
            <div class="desc-box">
                ...
                <a-upload name="file" :action="hostname+'/api/universal/v1/feedback/uploadimage'" list-type="picture-card"
...
import CompressImg from "@/assets/utils/compressImg.js";
var ErrorTip={
    type: "请选择反馈类型",
    content: "请填写反馈内容",
    contact: "请填写联系方式",
...
export default {
    ...
    mounted(){
        ...
        if (_hostname === "localhost" || _hostname.includes("192.168.")) {
          this.hostname = "http://zhibo-dev.vzan.com";
        } else {
